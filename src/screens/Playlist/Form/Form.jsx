...
const Form = function ({ setAlert, ...props }) {
  ...
  const [urlImagem, setUrlImagem] = useState(props.data.photo_url)
  ...
  function handleOnSubmit(e){
    ...
    api.put(`/playlists/${props.data.id}`, formData, {
      headers: {
    ...
    .then( response => {
      ...
      props.setData({ ...props.data, name, description, photo_url: response.data.photo_url })
      props.onToggleModal()
