...
import LinkOfComma from '../../LinkOfComma/LinkOfComma'
...
const AlbumImage = function(props) {
  return (
    <article className="card-container">
      <a href={`${props.prefixRoute}${props.data.id}`} className="d-block card-content">
        ...
        <div className="song-description mt-2">
          ...
          <div className="song-description-body hide-text-two-lines">
            <LinkOfComma
              data={props.comma}
              prefixRoute={props.prefixRoute}
            />
          </div>
        </div>
